    ...
    <>
      <div className="main">
        <div className="page-1">
          ...
          />
          <div className="nav">
            <Link to="/AddRestro" className="nav-link">
              Add restaurant
            </Link>
          ...
          <div className="input-selector">
            ...
            <input
              type="text"
              placeholder="Search for restorent, cuisine or a dish"
          ...
          <div className="wrapper-all-collections">
            <div className="available-order-option">
              <div className="option-1">
                ...
                <div className="option-1-content">
                  ...
                  <p className="option-1-description">
              ...
              <div className="option-2">
                ...
                <div className="option-2-content">
                  ...
                  <p className="option-2-description">
              ...
              <div className="option-3">
                ...
                <div className="option-3-content">
                  ...
                  <p className="option-3-description">
            ...
            <div className="available-collections">
              <div className="Collection-content">
                ...
                <h4 id="collection-description">
                  Explore curated lists of top restaurants, cafes, pubs, and
                  bars in Agra, based on trends
                </h4>
              </div>
              <div className="show-collections">
                <div className="collection-1">
                  <img
                    alt="img"
                    className="collection-1-img"
                    src="https://b.zmtcdn.com/data/collections/4a8fc66cfe2a43c7538d5716895a3019_1684739753.png?output-format=webp"
                  />

                  <p className="collection-1-orderType">
                    6 Taj View Restaurants
                  </p>
                ...
                <div className="collection-1">
                  <img
                    alt="img"
                    className="collection-1-img"
                    src="https://b.zmtcdn.com/data/collections/c3e8fb46e352ebb9d72c4f0cb5d27f39_1686042567.png?output-format=webp"
                  />

                  <p className="collection-1-orderType">
                    14 Local Favourite Places
                  </p>
                ...
                <div className="collection-1">
                  <img
                    alt="img"
                    className="collection-1-img"
                    src="https://b.zmtcdn.com/data/collections/a1e31eb92bb9951aaf1750d88497adb4_1684740352.jpg?output-format=webp"
                  />

                  <p className="collection-1-orderType">
                    18 Best Luxury Dining Places
                  </p>
                ...
                <div className="collection-1">
                  <img
                    alt="img"
                    className="collection-1-img"
                    src="https://b.zmtcdn.com/data/collections/a33a75bb9ce00650cde613173fe9d2ee_1684740006.png?output-format=webp"
                  />

                  <p className="collection-1-orderType">
                    6 Best Mughlai Places
                  </p>
            ...
            <div className="page-3-wrapper">
              <div className="page-3">
                <div className="papular-location-in-city">
                  <h5 id="heading-of-location">
                    Popular localities in and around Bhopal
                  </h5>
                </div>
